...
const initialQuestionsPerPlay = 5;

class QuizView extends Component {
  constructor(props) {
    super();
    this.state = {
      questionsPerPlay: initialQuestionsPerPlay,
      quizCategory: null,
      previousQuestions: [],
      showAnswer: false,
      categories: {},
  ...
  getNextQuestion = () => {
    ...
    $.ajax({
      url: `${this.state.apiVersion}/quizzes`, //TODO: update request URL
      type: 'POST',
      dataType: 'json',
      ...
      success: (result) => {
        this.setState({
          ...
          questionsPerPlay: result.total_questions >= initialQuestionsPerPlay ? initialQuestionsPerPlay : result.total_questions,
          guess: '',
